...
import {
  ...
  LayoutDashboard, Settings, LogOut, User
} from 'lucide-react'
...
export default function DashboardPage() {
  ...
  // Parse tech stack from JSON string or array
  const parseTech = (raw: string | string[]): string[] => {
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-colors ${
                  isActive
                    ...
                    : 'text-[#94949c] hover:text-[#e2e2e7] hover:bg-[#1a1a1e]'
                }`}
              >
